...
const Navbar = ({ setShowLogin }) => {
  ...
  const { getTotalCartAmount, token ,setToken, saveUser, theme, toggleTheme } = useContext(StoreContext);
  ...
  return (
    <div className='navbar'>
      ...
      <div className="navbar-right">
        <button className="navbar-theme-toggle" onClick={toggleTheme} title="Toggle theme" aria-label="Toggle theme">
          {theme === 'dark' ? '☀️' : '🌙'}
        </button>
